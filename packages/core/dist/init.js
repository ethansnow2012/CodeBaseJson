...
const cbj_representation_json_1 = __importDefault(require("./assets/cbj_representation.json"));
function init() {
    const destPath = path.join('./', 'cbj_representation.json');
    if (cbj_representation_json_1.default) {
        fs.writeFileSync(destPath, JSON.stringify(cbj_representation_json_1.default));
